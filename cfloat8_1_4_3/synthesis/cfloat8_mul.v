...
//
// On Sun Dec 10 00:44:55 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module cfloat8_mul(CLK,
  ...
  wire MUX_final_exp$write_1__SEL_1,
       ...
       MUX_stage$write_1__SEL_3,
       MUX_stage$write_1__SEL_4;
  ...
  wire [3 : 0] count_temp__h2134,
	       inter_mantissa1__h1465,
	       inter_mantissa2__h1466,
	       x__h2046,
	       x__h3295;
  wire [2 : 0] IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_final_ma_ETC___d59,
	       rounded_value__h3835;
  wire _0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_ETC___d61,
       hidden_bit_op1__h1397,
       hidden_bit_op2__h1398;
  ...
  assign MUX_stage$write_1__SEL_2 =
	     WILL_FIRE_RL_stage4 && normalized_man != 6'b0 ;
  assign MUX_stage$write_1__SEL_3 = WILL_FIRE_RL_stage3 && final_man != 8'b0 ;
  assign MUX_stage$write_1__SEL_4 = WILL_FIRE_RL_stage2 && final_exp != 4'b0 ;
  always@(final_man or
	  _0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_ETC___d61 or
	  x__h3295 or x__h2046)
  begin
    case (final_man[7:6])
      2'b10, 2'b11: MUX_final_exp$write_1__VAL_1 = x__h2046;
      default: MUX_final_exp$write_1__VAL_1 =
		   _0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_ETC___d61 ?
		     x__h3295 :
		     4'd0;
    endcase
  end
  ...
  assign final_man$D_IN =
	     { 4'd0,
	       NOT_exp_op1_5_EQ_0_4_5_CONCAT_man_op1_6_7_MUL__ETC___d32[3:0] } ;
  ...
  // register normalized_man
  always@(final_man or
	  IF_0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_ETC___d64 or
	  x__h1975)
  begin
    case (final_man[7:6])
      2'd0:
	  normalized_man$D_IN =
	      IF_0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_ETC___d64;
      2'b01: normalized_man$D_IN = final_man[5:0];
      2'b10, 2'b11: normalized_man$D_IN = x__h1975;
    endcase
  end
  ...
  assign rounded_man$D_IN =
	     normalized_man[2] ? rounded_value__h3835 : normalized_man[5:3] ;
  ...
  always@(EN_send or
	  ...
	  MUX_stage$write_1__SEL_4 or WILL_FIRE_RL_stage1)
  case (1'b1)
    EN_send: stage$D_IN = 3'd1;
    MUX_stage$write_1__SEL_2: stage$D_IN = MUX_stage$write_1__VAL_2;
    MUX_stage$write_1__SEL_3: stage$D_IN = MUX_stage$write_1__VAL_2;
    MUX_stage$write_1__SEL_4: stage$D_IN = MUX_stage$write_1__VAL_2;
    WILL_FIRE_RL_stage1: stage$D_IN = MUX_stage$write_1__VAL_2;
    default: stage$D_IN = 3'b010 /* unspecified value */ ;
  endcase
  assign stage$EN =
	     WILL_FIRE_RL_stage2 && final_exp != 4'b0 ||
  ...
  // remaining internal signals
  assign IF_0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_ETC___d64 =
	     _0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_ETC___d61 ?
	       x__h3221 :
	       x__h3335 ;
  assign IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_final_ma_ETC___d59 =
	     (final_man[5] ?
		3'd0 :
		(final_man[4] ?
		   3'd1 :
	     ...
	     3'd1 ;
  assign NOT_exp_op1_5_EQ_0_4_5_CONCAT_man_op1_6_7_MUL__ETC___d32 =
	     inter_mantissa1__h1465 * inter_mantissa2__h1466 ;
  assign _0_CONCAT_IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_ETC___d61 =
	     count_temp__h2134 < final_exp ;
  assign count_temp__h2134 =
	     { 1'd0,
	       IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_final_ma_ETC___d59 } ;
  assign hidden_bit_op1__h1397 = exp_op1 != 4'd0 ;
  assign hidden_bit_op2__h1398 = exp_op2 != 4'd0 ;
  assign inter_mantissa1__h1465 = { hidden_bit_op1__h1397, man_op1 } ;
  assign inter_mantissa2__h1466 = { hidden_bit_op2__h1398, man_op2 } ;
  assign rounded_value__h3835 = normalized_man[5:3] + 3'b001 ;
  assign x__h1975 = { 1'd0, final_man[5:1] } ;
  assign x__h2046 = final_exp + 4'd1 ;
  assign x__h3221 = final_man[5:0] << count_temp__h2134 ;
  assign x__h3295 = final_exp - count_temp__h2134 ;
  assign x__h3335 = final_man[5:0] << final_exp ;
  ...
  begin
	...
	$display("val of final exp : ",
		 ...
		 rg_operands[3:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_stage2 && final_exp != 4'b0)
	...
	$display("DEBUGG MSB count zeros : %b ",
		 $unsigned(IF_final_man_5_BIT_5_7_THEN_0_ELSE_IF_final_ma_ETC___d59),
		 "final exp : %b",
		 final_exp);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_stage4 && final_man[7:6] != 2'b01 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_stage4 && normalized_man != 6'b0)
